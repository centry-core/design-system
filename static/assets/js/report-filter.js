const ChooseFilter = {
    ...
    emits: ['delete-filter', 'select-filter', 'create-filter'],
    data() {
        return {
            deletingId: null,
        }
...
register_component('choose-filter', ChooseFilter)
register_component('modal-save-filter', modalSaveFilter)
register_component('report-filter', ReportFilter)
